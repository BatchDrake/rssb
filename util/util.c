...
int
strlist_find (const struct strlist *list, const char *string)
{
  int i;
...
{
  return strlist_find(list, string) != -1;
}
...
arg_list_t *
__split_command (const char *line, const char *separators, int fixed_sep_size)
{
  int p, i;
